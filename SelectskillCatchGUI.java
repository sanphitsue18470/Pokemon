...
public class SelectskillCatchGUI extends JFrame{
    ...
    public SelectskillCatchGUI(Trainer trainer, Pokemon wildPokemon){
        super("Pokemon Game");
        ...
        Pokemon myPokemon = trainer.GetPokemon(trainer.getCountselectskill());
